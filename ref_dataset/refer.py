...
class REFER:
	...
	def __init__(self, data_root='./datasets', dataset='refcoco', splitBy='unc'):
		...
		if dataset in ['refcoco', 'refcoco+', 'refcocog']:
			self.IMAGE_DIR = osp.join(data_root, 'train2014') #图片地址
		...
		self.data['refs'] = pickle.load(open(ref_file, 'rb'))#rb 表示用二进制打开文件
